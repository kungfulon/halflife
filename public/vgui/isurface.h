...
public:
	...
	virtual void DrawUpdateRegionTextureBGRA(int id, const unsigned char *rgba, int wide, int tall);
	virtual void DrawSetTextureBGRA(int id, const unsigned char *rgba, int wide, int tall);

	//virtual void CreateBrowser(class ISurface *, VPANEL, class IHTMLResponses *, bool, const char  *);
	//virtual void RemoveBrowser(class ISurface *, VPANEL, class IHTMLResponses *);
	//virtual class IHTMLChromeController * AccessChromeHTMLController(class ISurface *);
};
